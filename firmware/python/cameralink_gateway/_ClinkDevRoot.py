...
rogue.Version.maxVersion('999.999.999')
    ...
    def start(self, **kwargs):
        ...
        if (self.dev is 'sim'):
            ...
            if (self.enableDump):
                ...
                self.remoteVariableDump('dump/regdump-pre-config.txt', ['RO','RW','WO'], False );
        ...
        if (self.enableDump):
            ...
            self.remoteVariableDump('dump/regdump-post-config.txt', ['RO','RW','WO'], False );
